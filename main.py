...
async def about_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    log.info(f"list_command: {users}")
    await update.message.reply_text("""
البوت يعمل بشكل آلى دون في أوقات الغداء...
(لا حاجه لاستخدام الأوامر في ادارة البوت إذا كنت لا ترغب في ذلك)

حيث يقوم البوت بحفظ اسماء المشاركين في المحادثه قبيل معاد الغداء
